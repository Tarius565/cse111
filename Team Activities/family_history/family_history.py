...
def print_death_age(people_dict):
    ...
    for person_key, person_value in people_dict.items():
        name = person_value[NAME_INDEX]
        age = person_value[DEATH_YEAR_INDEX]-person_value[BIRTH_YEAR_INDEX]
...
def count_genders(people_dict):
    ...
    num_males = 0
    for person_key, person_value in people_dict.items():
        gender = person_value[GENDER_INDEX]
        if gender == "M":
            num_males += 1
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage_key, marriage_value in marriages_dict.items():
        ...
        wedding_year = marriage_value[WEDDING_YEAR_INDEX]
        ...
        wife_age = wedding_year - husband_birth
